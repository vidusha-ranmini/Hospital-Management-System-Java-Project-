...
public class AppointmentAdminController {
    ...
    @FXML
    private TableView<AppointmentAdmin> appointmentTable;

    @FXML
    private TableColumn<AppointmentAdmin, Integer> idColumn;

    @FXML
    private TableColumn<AppointmentAdmin, String> patientNameColumn, doctorNameColumn, dateColumn, timeColumn, reasonColumn;

    private ObservableList<AppointmentAdmin> appointments;
    ...
    private void handleAddAppointment() {
        ...
        AppointmentAdmin newAppointment = new AppointmentAdmin(0, patientNameField.getText(), doctorNameField.getText(), dateField.getText(), timeField.getText(), reasonField.getText());
    ...
    private void handleUpdateAppointment() {
        AppointmentAdmin selectedAppointment = appointmentTable.getSelectionModel().getSelectedItem();
    ...
    private void populateFields(AppointmentAdmin appointment) {
